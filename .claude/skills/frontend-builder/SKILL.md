...
Before adding, updating, or composing any shadcn/ui component, invoke the `shadcn-ui` skill and follow its rules. This is non-optional for any work under `src/frontend/src/components/ui/` or anything importing from `@/components/ui/*`.
...
This tool is used by engineers and analysts — the audience is technical. When in doubt, lean toward **precise, editorial, and trustworthy** rather than playful. Dark themes work well for this context.
...
- Components stay under 150 lines; extract sub-components if they grow
