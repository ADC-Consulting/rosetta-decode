...
Creates a complete "Customer Revenue Pipeline" job that demonstrates:
...
DEMO_JOB_NAME = "Customer Revenue Pipeline"
...
GENERATED_FILES = {
    "pipeline.py": """\
\"\"\"Customer Revenue Pipeline — generated by Rosetta Decode.\"\"\"
...
MIGRATION_PLAN = {
    "summary": (
        "Customer Revenue Pipeline migrates a 6-script SAS ETL into Python/pandas. "
