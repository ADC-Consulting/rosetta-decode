...
def test_macro_resolver_make_agent_tensorzero_path() -> None:
    ...
    with (
        patch("src.worker.engine.agents.macro_resolver.worker_settings", mock_settings),
        patch(
            "src.worker.engine.agents.macro_resolver.OpenAIProvider",
            return_value=mock_tz_provider,
        ),
        patch(
            "src.worker.engine.agents.macro_resolver.OpenAIChatModel",
            return_value=mock_model,
        ) as mock_oai_model,
        patch("src.worker.engine.agents.macro_resolver.Agent", return_value=mock_agent),
    ):
        from src.worker.engine.agents.macro_resolver import _make_agent
...
def test_macro_resolver_make_agent_azure_path() -> None:
    ...
    with (
        patch("src.worker.engine.agents.macro_resolver.worker_settings", mock_settings),
        patch(
            "src.worker.engine.agents.macro_resolver.AzureProvider",
            return_value=mock_azure_provider,
        ) as mock_az,
        patch("src.worker.engine.agents.macro_resolver.OpenAIChatModel", return_value=mock_model),
        patch("src.worker.engine.agents.macro_resolver.Agent", return_value=mock_agent),
    ):
        from src.worker.engine.agents.macro_resolver import _make_agent
