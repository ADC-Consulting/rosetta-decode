---
name: Backend
description: Invoked as a subagent by the Orchestrator. Implements Python backend code for rosetta-decode — FastAPI routes, worker engine functions, Pydantic AI agents, ComputeBackend implementations, Alembic migrations, and validation logic. Never plans features or commits.
